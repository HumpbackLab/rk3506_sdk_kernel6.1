...
static struct token_perm_node *g_token_perm_root;
static size_t g_total_node_num;
...
static int access_tokenid_init_module(void)
{
	...
	g_cache = kmem_cache_create("access_token_node",
				    sizeof(struct token_perm_node), 0,
